...
# Indexes will be used to mark the points in particular arrays of specific colour
blue_index = 0
green_index = 0
red_index = 0
yellow_index = 0
...
cap.set(3, 636)  # Set width to match paintWindow width
cap.set(4, 471)  # Set height to match paintWindow height
...
while ret:
    ...
    # Resizing frame to match paintWindow dimensions
    frame = cv2.resize(frame, (636, 471))
